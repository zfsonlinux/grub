...
fs-libusb_mod-bus_usb_emu_usb.lst: bus/usb/emu/usb.c $(bus/usb/emu/usb.c_DEPENDENCIES) genfslist.sh
	set -e; 	  $(TARGET_CC) -Ibus/usb/emu -I$(srcdir)/bus/usb/emu $(TARGET_CPPFLAGS)  $(TARGET_CFLAGS) $(libusb_mod_CFLAGS) -E $< 	  | sh $(srcdir)/genfslist.sh libusb > $@ || (rm -f $@; exit 1)
...
partmap-libusb_mod-bus_usb_emu_usb.lst: bus/usb/emu/usb.c $(bus/usb/emu/usb.c_DEPENDENCIES) genpartmaplist.sh
	set -e; 	  $(TARGET_CC) -Ibus/usb/emu -I$(srcdir)/bus/usb/emu $(TARGET_CPPFLAGS)  $(TARGET_CFLAGS) $(libusb_mod_CFLAGS) -E $< 	  | sh $(srcdir)/genpartmaplist.sh libusb > $@ || (rm -f $@; exit 1)
...
video-libusb_mod-bus_usb_emu_usb.lst: bus/usb/emu/usb.c $(bus/usb/emu/usb.c_DEPENDENCIES) genvideolist.sh
	set -e; 	  $(TARGET_CC) -Ibus/usb/emu -I$(srcdir)/bus/usb/emu $(TARGET_CPPFLAGS)  $(TARGET_CFLAGS) $(libusb_mod_CFLAGS) -E $< 	  | sh $(srcdir)/genvideolist.sh libusb > $@ || (rm -f $@; exit 1)
...
fs-sdl_mod-video_emu_sdl.lst: video/emu/sdl.c $(video/emu/sdl.c_DEPENDENCIES) genfslist.sh
	set -e; 	  $(TARGET_CC) -Ivideo/emu -I$(srcdir)/video/emu $(TARGET_CPPFLAGS)  $(TARGET_CFLAGS) $(sdl_mod_CFLAGS) -E $< 	  | sh $(srcdir)/genfslist.sh sdl > $@ || (rm -f $@; exit 1)
...
partmap-sdl_mod-video_emu_sdl.lst: video/emu/sdl.c $(video/emu/sdl.c_DEPENDENCIES) genpartmaplist.sh
	set -e; 	  $(TARGET_CC) -Ivideo/emu -I$(srcdir)/video/emu $(TARGET_CPPFLAGS)  $(TARGET_CFLAGS) $(sdl_mod_CFLAGS) -E $< 	  | sh $(srcdir)/genpartmaplist.sh sdl > $@ || (rm -f $@; exit 1)
...
video-sdl_mod-video_emu_sdl.lst: video/emu/sdl.c $(video/emu/sdl.c_DEPENDENCIES) genvideolist.sh
	set -e; 	  $(TARGET_CC) -Ivideo/emu -I$(srcdir)/video/emu $(TARGET_CPPFLAGS)  $(TARGET_CFLAGS) $(sdl_mod_CFLAGS) -E $< 	  | sh $(srcdir)/genvideolist.sh sdl > $@ || (rm -f $@; exit 1)
...
fs-pci_mod-bus_emu_pci.lst: bus/emu/pci.c $(bus/emu/pci.c_DEPENDENCIES) genfslist.sh
	set -e; 	  $(TARGET_CC) -Ibus/emu -I$(srcdir)/bus/emu $(TARGET_CPPFLAGS)  $(TARGET_CFLAGS) $(pci_mod_CFLAGS) -E $< 	  | sh $(srcdir)/genfslist.sh pci > $@ || (rm -f $@; exit 1)
...
partmap-pci_mod-bus_emu_pci.lst: bus/emu/pci.c $(bus/emu/pci.c_DEPENDENCIES) genpartmaplist.sh
	set -e; 	  $(TARGET_CC) -Ibus/emu -I$(srcdir)/bus/emu $(TARGET_CPPFLAGS)  $(TARGET_CFLAGS) $(pci_mod_CFLAGS) -E $< 	  | sh $(srcdir)/genpartmaplist.sh pci > $@ || (rm -f $@; exit 1)
...
video-pci_mod-bus_emu_pci.lst: bus/emu/pci.c $(bus/emu/pci.c_DEPENDENCIES) genvideolist.sh
	set -e; 	  $(TARGET_CC) -Ibus/emu -I$(srcdir)/bus/emu $(TARGET_CPPFLAGS)  $(TARGET_CFLAGS) $(pci_mod_CFLAGS) -E $< 	  | sh $(srcdir)/genvideolist.sh pci > $@ || (rm -f $@; exit 1)
...
fs-pci_mod-commands_lspci.lst: commands/lspci.c $(commands/lspci.c_DEPENDENCIES) genfslist.sh
	set -e; 	  $(TARGET_CC) -Icommands -I$(srcdir)/commands $(TARGET_CPPFLAGS)  $(TARGET_CFLAGS) $(pci_mod_CFLAGS) -E $< 	  | sh $(srcdir)/genfslist.sh pci > $@ || (rm -f $@; exit 1)
...
partmap-pci_mod-commands_lspci.lst: commands/lspci.c $(commands/lspci.c_DEPENDENCIES) genpartmaplist.sh
	set -e; 	  $(TARGET_CC) -Icommands -I$(srcdir)/commands $(TARGET_CPPFLAGS)  $(TARGET_CFLAGS) $(pci_mod_CFLAGS) -E $< 	  | sh $(srcdir)/genpartmaplist.sh pci > $@ || (rm -f $@; exit 1)
...
video-pci_mod-commands_lspci.lst: commands/lspci.c $(commands/lspci.c_DEPENDENCIES) genvideolist.sh
	set -e; 	  $(TARGET_CC) -Icommands -I$(srcdir)/commands $(TARGET_CPPFLAGS)  $(TARGET_CFLAGS) $(pci_mod_CFLAGS) -E $< 	  | sh $(srcdir)/genvideolist.sh pci > $@ || (rm -f $@; exit 1)
