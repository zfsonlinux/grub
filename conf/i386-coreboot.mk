...
kernel_img-kern_i386_coreboot_startup.o: kern/i386/coreboot/startup.S $(kern/i386/coreboot/startup.S_DEPENDENCIES)
	$(TARGET_CC) -Ikern/i386/coreboot -I$(srcdir)/kern/i386/coreboot $(TARGET_CPPFLAGS) -DASM_FILE=1 $(TARGET_ASFLAGS) $(kernel_img_ASFLAGS) -DGRUB_FILE=\"kern/i386/coreboot/startup.S\" -MD -c -o $@ $<

-include kernel_img-kern_i386_coreboot_startup.d

kernel_img_OBJECTS += kernel_img-kern_i386_coreboot_startup.o
...
kernel_img-kern_i386_coreboot_mmap.o: kern/i386/coreboot/mmap.c $(kern/i386/coreboot/mmap.c_DEPENDENCIES)
	$(TARGET_CC) -Ikern/i386/coreboot -I$(srcdir)/kern/i386/coreboot $(TARGET_CPPFLAGS)  $(TARGET_CFLAGS) $(kernel_img_CFLAGS) -DGRUB_FILE=\"kern/i386/coreboot/mmap.c\" -MD -c -o $@ $<

-include kernel_img-kern_i386_coreboot_mmap.d

kernel_img_OBJECTS += kernel_img-kern_i386_coreboot_mmap.o
