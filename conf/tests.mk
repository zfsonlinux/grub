...
fs-functional_test_mod-tests_lib_functional_test.lst: tests/lib/functional_test.c $(tests/lib/functional_test.c_DEPENDENCIES) genfslist.sh
	set -e; 	  $(TARGET_CC) -Itests/lib -I$(srcdir)/tests/lib $(TARGET_CPPFLAGS)  -DGRUB_LST_GENERATOR $(TARGET_CFLAGS) $(functional_test_mod_CFLAGS) -E $< 	  | sh $(srcdir)/genfslist.sh functional_test > $@ || (rm -f $@; exit 1)
...
partmap-functional_test_mod-tests_lib_functional_test.lst: tests/lib/functional_test.c $(tests/lib/functional_test.c_DEPENDENCIES) genpartmaplist.sh
	set -e; 	  $(TARGET_CC) -Itests/lib -I$(srcdir)/tests/lib $(TARGET_CPPFLAGS)  -DGRUB_LST_GENERATOR $(TARGET_CFLAGS) $(functional_test_mod_CFLAGS) -E $< 	  | sh $(srcdir)/genpartmaplist.sh functional_test > $@ || (rm -f $@; exit 1)
...
video-functional_test_mod-tests_lib_functional_test.lst: tests/lib/functional_test.c $(tests/lib/functional_test.c_DEPENDENCIES) genvideolist.sh
	set -e; 	  $(TARGET_CC) -Itests/lib -I$(srcdir)/tests/lib $(TARGET_CPPFLAGS)  -DGRUB_LST_GENERATOR $(TARGET_CFLAGS) $(functional_test_mod_CFLAGS) -E $< 	  | sh $(srcdir)/genvideolist.sh functional_test > $@ || (rm -f $@; exit 1)
...
fs-example_functional_test_mod-tests_example_functional_test.lst: tests/example_functional_test.c $(tests/example_functional_test.c_DEPENDENCIES) genfslist.sh
	set -e; 	  $(TARGET_CC) -Itests -I$(srcdir)/tests $(TARGET_CPPFLAGS)  -DGRUB_LST_GENERATOR $(TARGET_CFLAGS) $(example_functional_test_mod_CFLAGS) -E $< 	  | sh $(srcdir)/genfslist.sh example_functional_test > $@ || (rm -f $@; exit 1)
...
partmap-example_functional_test_mod-tests_example_functional_test.lst: tests/example_functional_test.c $(tests/example_functional_test.c_DEPENDENCIES) genpartmaplist.sh
	set -e; 	  $(TARGET_CC) -Itests -I$(srcdir)/tests $(TARGET_CPPFLAGS)  -DGRUB_LST_GENERATOR $(TARGET_CFLAGS) $(example_functional_test_mod_CFLAGS) -E $< 	  | sh $(srcdir)/genpartmaplist.sh example_functional_test > $@ || (rm -f $@; exit 1)
...
video-example_functional_test_mod-tests_example_functional_test.lst: tests/example_functional_test.c $(tests/example_functional_test.c_DEPENDENCIES) genvideolist.sh
	set -e; 	  $(TARGET_CC) -Itests -I$(srcdir)/tests $(TARGET_CPPFLAGS)  -DGRUB_LST_GENERATOR $(TARGET_CFLAGS) $(example_functional_test_mod_CFLAGS) -E $< 	  | sh $(srcdir)/genvideolist.sh example_functional_test > $@ || (rm -f $@; exit 1)
