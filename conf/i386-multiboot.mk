...
kernel_img-kern_i386_multiboot_mmap.o: kern/i386/multiboot_mmap.c $(kern/i386/multiboot_mmap.c_DEPENDENCIES)
	$(TARGET_CC) -Ikern/i386 -I$(srcdir)/kern/i386 $(TARGET_CPPFLAGS)  $(TARGET_CFLAGS) $(kernel_img_CFLAGS) -DGRUB_FILE=\"kern/i386/multiboot_mmap.c\" -MD -c -o $@ $<

-include kernel_img-kern_i386_multiboot_mmap.d

kernel_img_OBJECTS += kernel_img-kern_i386_multiboot_mmap.o
