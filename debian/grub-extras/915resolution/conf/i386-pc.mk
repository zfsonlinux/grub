...
fs-915resolution_mod-__GRUB_CONTRIB__915resolution_915resolution.lst: $(GRUB_CONTRIB)/915resolution/915resolution.c $($(GRUB_CONTRIB)/915resolution/915resolution.c_DEPENDENCIES) genfslist.sh
	set -e; 	  $(TARGET_CC) -I$(GRUB_CONTRIB)/915resolution -I$(srcdir)/$(GRUB_CONTRIB)/915resolution $(TARGET_CPPFLAGS)  -DGRUB_LST_GENERATOR $(TARGET_CFLAGS) $(915resolution_mod_CFLAGS) -E $< 	  | sh $(srcdir)/genfslist.sh 915resolution > $@ || (rm -f $@; exit 1)
...
partmap-915resolution_mod-__GRUB_CONTRIB__915resolution_915resolution.lst: $(GRUB_CONTRIB)/915resolution/915resolution.c $($(GRUB_CONTRIB)/915resolution/915resolution.c_DEPENDENCIES) genpartmaplist.sh
	set -e; 	  $(TARGET_CC) -I$(GRUB_CONTRIB)/915resolution -I$(srcdir)/$(GRUB_CONTRIB)/915resolution $(TARGET_CPPFLAGS)  -DGRUB_LST_GENERATOR $(TARGET_CFLAGS) $(915resolution_mod_CFLAGS) -E $< 	  | sh $(srcdir)/genpartmaplist.sh 915resolution > $@ || (rm -f $@; exit 1)
...
video-915resolution_mod-__GRUB_CONTRIB__915resolution_915resolution.lst: $(GRUB_CONTRIB)/915resolution/915resolution.c $($(GRUB_CONTRIB)/915resolution/915resolution.c_DEPENDENCIES) genvideolist.sh
	set -e; 	  $(TARGET_CC) -I$(GRUB_CONTRIB)/915resolution -I$(srcdir)/$(GRUB_CONTRIB)/915resolution $(TARGET_CPPFLAGS)  -DGRUB_LST_GENERATOR $(TARGET_CFLAGS) $(915resolution_mod_CFLAGS) -E $< 	  | sh $(srcdir)/genvideolist.sh 915resolution > $@ || (rm -f $@; exit 1)
